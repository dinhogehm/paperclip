...
export const issueStatusIcon: Record<string, string> = {
  ...
  pr_open: "text-cyan-600 border-cyan-600 dark:text-cyan-400 dark:border-cyan-400",
  merged: "text-teal-600 border-teal-600 dark:text-teal-400 dark:border-teal-400",
  in_production: "text-emerald-600 border-emerald-600 dark:text-emerald-400 dark:border-emerald-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  pr_open: "text-cyan-600 dark:text-cyan-400",
  merged: "text-teal-600 dark:text-teal-400",
...
export const statusBadge: Record<string, string> = {
  ...
  pr_open: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300",
  merged: "bg-teal-100 text-teal-700 dark:bg-teal-900/50 dark:text-teal-300",
  in_production: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300",
...
export const taskStatusVar: Record<string, string> = {
  ...
  pr_open: "--status-task-pr_open",
  merged: "--status-task-merged",
  in_production: "--status-task-in_production",
...
export const taskStatusIconVar: Record<string, string> = {
  ...
  pr_open: "--status-task-icon-pr_open",
  merged: "--status-task-icon-merged",
  in_production: "--status-task-icon-in_production",
