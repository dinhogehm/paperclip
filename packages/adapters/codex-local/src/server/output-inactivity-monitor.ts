...
export const DEFAULT_CODEX_OUTPUT_INACTIVITY_TIMEOUT_MS = 20 * 60 * 1000;
 ...
 * - missing/`undefined` → default 20m.
 * - number > 0     → configured value.
 * - number ≤ 0     → default 20m (and a `non_positive` note for logging).
 */
